<?php
  ...
  $usuario = $_SESSION['usuario'];
              ...
              $sql = "SELECT * FROM confidente WHERE confidente1 = '$usuario'";
...
<head>
	...
	<title>Confidentes de @<?php echo $_SESSION['usuario']; ?> </title>
...
<body>
	...
	<div class="izquierda">
		<div style="color: #880015; font-size: 35px; margin-left: 25%; margin-top: 5%;">Lista de Confidentes</div>
		<hr>
		<div class="usuarios">
			<?php
              $sql = "SELECT * FROM confidente WHERE confidente1 = '$usuario'";
			...
			<div class="usuario-izq">@<?php echo $rw_seguidos['confidente2']; ?></div>
