<?php
  ...
  $usuario = $_SESSION['usuario'];
              ...
              $sql = "SELECT * FROM seguido WHERE seguido = '$usuario'";
...
<body>
	...
	<div class="izquierda">
		<div style="color: #880015; font-weight: 900; font-size: 35px; margin-left: 25%; margin-top: 5%;">Lista de Seguidores</div>
		<hr>
		<div class="usuarios">
			<?php
              $sql = "SELECT * FROM seguido WHERE seguido = '$usuario'";
			...
			<div class="usuario-izq">@<?php echo $rw_seguidos['seguidopor']; ?></div>
