...
<html lang="es">
    ...
    <div class="desglose">
      ...
      <div class="derecha" style="padding-top: 3%; padding-left: 5%">
        OPCIONES<br>
        <a id="imagenId" class="btn-conf btn-conf-ver" class="accordion-toggle" data-toggle="collapse" href="#collapseOne">Contrase&ntilde;a <div id="signo" style="padding-left: 10px; float: right; color: #88015;">+</div></a>
        ...
        <a id="imagenId2" class="btn-conf btn-conf-ver" class="accordion-toggle" data-toggle="collapse" href="#collapseTwo">Correo <div id="signo" style="padding-left: 10px; float: right; color: #88015;">+</div></a>
        ...
        <a id="imagenId3" class="btn-conf btn-conf-ver" class="accordion-toggle" data-toggle="collapse" href="#collapseTree">Validacion de Acceso <div id="signo" style="padding-left: 10px; float: right; color: #88015;">+</div></a>
...
<br>
                ...
                <a id="imagenId4" class="btn-conf btn-conf-ver" class="accordion-toggle" data-toggle="collapse" href="#collapseFour">Cuenta <div id="signo" style="padding-left: 10px; float: right; color: #88015;">+</div></a>
...
<a id="imagenId5" class="btn-conf btn-conf-ver" class="accordion-toggle" data-toggle="collapse" href="#collapseFive">Mas Informacion <div id="signo" style="padding-left: 10px; float: right; color: #88015;">+</div></a>
