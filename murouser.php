...
<head>
  ...
  <title>Muro de @<?php echo $xxx; ?> </title>
...
<body>
  <div class="barra-superior">
    ...
    <div class="contener">
    <div class="izquierda">
      <?php include('menu_izquser.php'); ?>
    </div>

    <div class="centro">
    
    <?php
      $sql = "SELECT * FROM entrada WHERE compartir = 's' AND usuario = '$xxx' ORDER BY fecha DESC";
      $eje = pg_query($dbcon, $sql);
    ...
    <div class="publicacion">
      ...
      <div class="superior">
        ...
        <?php
            if($sexo == 'h'){
              echo "<img src='img/sexos/masculino2.png' width='80%' style='margin-left:15%; margin-top:15%'>";
            }
            if($sexo == 'm'){
              echo "<img src='img/sexos/femenino2.png' width='60%' style='margin-left:20%;'>";
            }
            if($sexo == 'hi'){
              echo "<img src='img/sexos/masculinointerrogativo2.png' width='80%'>";
            }
            if($sexo == 'mi'){
