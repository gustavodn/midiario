...
<body>
	...
	<div class="desglose">
		<div class="titulo">Lista de Estados (<?php echo $count; ?>)  <a href="nuevo_estado.php">Agregar Estado de Animo</a></div>
		<table width="80%" style="text-align: left; font-size: 15px;" class="tabla">
			<thead>
				<tr>
					<th width="25%">Estado de Animo</th>
			...
			?>
				<tr>
					<td><?php echo $rw_usuarios['estado']; ?></td>
					<td><?php echo $rw_usuarios['quien']; ?></td>
					<td><?php echo $rw_usuarios['cuando']; ?></td>
					<td><a href="delete_estado.php?id=<?php echo $id; ?>">Eliminar</a></td>
				</tr>
				<?php
			}
				?>
